...
Task.create!(user_id: 1, list_id: 1, title: "Compost Norbert's egg shells", due_date: DateTime.new(2021, 4, 10))
...
Task.create!(user_id: 1, list_id: 5, title: "Keep quiet about the you-know-what that Fluffy is guarding from You-Know-Who", due_date: DateTime.new(1992, 5, 17 ) )
