...
Task.create!(user_id: 1, list_id: 1, title: "Replace the teapot the rat hid in", due_date: DateTime.new(2021, 7, 2))
Task.create!(user_id: 1, list_id: 1, title: "Compost Norbert's egg shells", due_date: DateTime.new(2021, 4, 10), complete: true)
Task.create!(user_id: 1, list_id: 1, title: "Return Filius' timpani", due_date: DateTime.new(2021, 4, 16))
...
Task.create!(user_id: 1, list_id: 2, title: "Gather firewood for the winter", due_date: DateTime.new(2020, 9, 30), estimate: 60, complete: true)
Task.create!(user_id: 1, list_id: 3, title: "Get saddles for the thestrals so the students can see them", due_date: DateTime.new(2021, 6, 23 ))
...
Task.create!(user_id: 1, list_id: 4, title: "Distract Grawp from scaring the centaurs", due_date: DateTime.new(2021,7, 1) )
Task.create!(user_id: 1, list_id: 4, title: "Teach Grawp how to shave", due_date: DateTime.new(2019, 7, 3), complete: true)
...
Task.create!(user_id: 1, title: "Track down the niffler that stole my Galleons", due_date: DateTime.new(2021, 4, 17 ) )
Task.create!(user_id: 1, title: "Make a stable for Buckbeak", due_date: DateTime.new(2021, 4, 17 ))
Task.create!(user_id: 1, title: "Get a new wand", due_date: DateTime.new(2007, 8, 20 ), complete: true)
